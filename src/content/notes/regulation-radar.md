...
The <a href="/notes/better-call-saullm" target="_blank">previous experiment</a> in this series asked six models to classify ambiguous legal documents. They disagreed extensively, and there was no ground truth to grade against.

This time, there was an answer key. Sort of.

The EU doesn't just publish legislation. It **tags** it. Every regulation gets classified using <a href="https://op.europa.eu/en/web/eu-vocabularies/concept-scheme/-/resource?uri=http://eurovoc.europa.eu/100141" target="_blank">EuroVoc</a>, a controlled vocabulary of roughly 7,000 terms organised into **21 top-level thematic domains** – "Agriculture", "Trade", "Finance", "Energy", and so on. The tagging is done by professional librarians at the Publications Office, and has been running since 1995.
